...
class FlxG
{
	...
	public static var initialWidth(default, set):Int = 0;
	public static var initialHeight(default, set):Int = 0;
	...
	public static inline function set_width(value:Int) {
		width = value;
		return width;
	}

	public static inline function set_height(value:Int) {
		height = value;
		return height;
	}

	public static inline function set_initialWidth(value:Int) {
		initialWidth = value;
		return initialWidth;
	}

	public static inline function set_initialHeight(value:Int) {
		initialHeight = value;
